...
- `COMMAND`:
  - `createVault --tradingPair <trading pair> --linkedPrice <price> --quantity <quantity> --expiry <UNIX epoch> --yieldPercentage <yield rate> [--isBuyLow] [--hedge <exchange name>]`: Create a vault with command line arguments
...
| Creation Date | Network      | Trading Pair | Linked Price | Yield Percentage | Expire Date | Direction | Quantity | Hedge   |
| ------------- | ------------ | ------------ | ------------:| ----------------:| ----------- | --------- | --------:| ------- |
| 2024/08/24    | Bera Testnet | WETH-USDC    |         3000 |               1% | 2024/08/30  | Buy Low   |      100 | Deribit |
